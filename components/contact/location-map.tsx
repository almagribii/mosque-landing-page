    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-muted-foreground mb-8">
                Masjid Al-Hikmah terletak di lokasi strategis dan mudah diakses
                dari berbagai area. Kami terbuka untuk semua orang yang ingin
            ...
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:info@masjidalkhikmah.id"
                    className="text-muted-foreground text-sm hover:text-primary"
                  >
          ...
          >
            <div className="relative w-full h-64 sm:h-80 lg:h-96 rounded-2xl overflow-hidden border border-border shadow-lg">
              <iframe
            ...
            {/* Jam Operasional */}
            <div
              className={`bg-card border border-border rounded-xl p-4 sm:p-6 mt-4 sm:mt-6 transform transition-all duration-700 delay-300 ${
                isVisible
            ...
            >
              ...
              <p className="text-xs text-muted-foreground mt-4">
                Masjid kami buka 24 jam untuk memudahkan jamaah beribadah kapan
                saja
              </p>
            </div>
          </div>
