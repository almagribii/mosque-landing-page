...
export default function BenefitsSection() {
  ...
  return (
    <section id="benefits" className="py-20 bg-gradient-to-b from-primary/5 to-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl font-bold text-foreground mb-6">Manfaat Bergabung Dengan Kami</h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Bergabunglah dengan komunitas Masjid Al-Hikmah dan rasakan perubahan positif dalam kehidupan spiritual dan
              sosial Anda. Kami berkomitmen untuk memberikan yang terbaik.
            </p>
          ...
          {/* Right - Visual */}
          <div
            className={`relative h-96 transform transition-all duration-1000 delay-300 ${
              isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"
            }`}
          >
